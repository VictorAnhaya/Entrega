    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                Console.Write("Qual voce dejesa? ");
                ...
                switch (opcao)
                {
                    case 1:
                        ...
                        Console.WriteLine($"Nome de Beta em!, {nome}");
                        break;
                    ...
                    case 2:
                        ...
                        Console.WriteLine($"Seu Betinha, se tem {idade} anos.");
                        break;
                    ...
                    case 6:
                        Console.WriteLine("Tchau Looser!");
                        break;

                    default:
                        Console.WriteLine("Sobra Nada pro betinha!");
                        break;
                }
